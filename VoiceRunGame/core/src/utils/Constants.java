...
public class Constants {
    ...
    public static final float GROUND_HEIGHT = 2f /** 2f*/;
    ...
    public static final float RUNNER_DENSITY = 0.5f; //add final !!!

    public static final float RUNNER_GRAVITY_SCALE = 3f;
    public static final Vector2 RUNNER_JUMPING_LINEAR_IMPULSE = new Vector2(0, 13f);

    //{ begin!!!
    //added for touch event
    public static final float RUNNER_DODGE_X = 2f;
    public static final float RUNNER_DODGE_Y = 1.5f; /*+ 1f;*/
    //} end !!!
    ...
    /**
     *  I am translating 1 meter as 32 pixels
     */
